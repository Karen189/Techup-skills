const team = {
  ...
  team.addPlayer('teta','mutesi',28);
  team.addPlayer('Urbain','Mutangana',44);
  team.addPlayer('Gad','Matt',76); 
  //Print out the team players
  console.log(team.players);
  
  //Invoking addGames Method on three games and print out the teams updated games array
  team.addGame('UMUCO Cup', 100, 98);
  team.addGame('Champion', 35, 62);
  team.addGame('T30 Trophy', 87, 91);
